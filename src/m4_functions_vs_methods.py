...
def try_methods_and_functions():
    ...
    martha.pen = rg.Pen('blue', 5)
    martha.backward(150)
    martha.speed = 1
    draw_many_squares(martha, 2, 100, 30)
    martha.speed = 5
    martha.pen.color = 'red'
    draw_many_squares(martha, 10, 50, 15)
    martha.speed = 100
    martha.pen.thickness = 35
    draw_many_squares(martha, 8, 300, 60)
    martha.pen = rg.Pen('black', 3)
    martha.backward(200)
